  ...
  return (
    <div className="w-full flex flex-col max-mobile:gap-0.5 gap-1.5">
      ...
      {type !== "textarea" ? (
        ...
        <textarea
          className={`w-full max-mobile:text-xs  text-base font-normal placeholder:text-gray-500 text-gray-700 bg-white border border-[#E4E4F6] rounded-xl outline-0 py-2.5 px-3.5 ${
      ...
      {guideLine && (
        <span className="text-sm max-tablet:leading-normal max-tablet:text-[10px] font-normal leading-5 text-gray-600">
          {guideLine}
        </span>
      )}
    </div>
