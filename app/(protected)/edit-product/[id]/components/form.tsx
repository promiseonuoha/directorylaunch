      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full flex flex-col max-mobile:gap-0.5 gap-1.5">
          <div className="flex w-max h-max items-start">
            <label
              className={` font-medium max-mobile:text-xs text-black/70 text-base leading-6`}
            >
              Tags
            </label>
          </div>
          <div className="w-full overflow-hidden flex flex-col rounded-xl border border-[#E4E4F6]">
            <TagsInput
              addTag={(tag) => {
                setTags((prev) => {
                  return [tag, ...prev];
        ...
        <div className="w-full flex flex-col max-tablet:gap-3 gap-6">
          <div className="flex w-max h-max items-start">
            <label
              className={`text-base max-tablet:text-xs leading-6 font-medium text-gray-700 `}
            >
              Pricing Type
            </label>{" "}
            &nbsp;
            <span className="text-sm max-tablet:text-xs text-red-600">*</span>
          </div>
        ...
        <div className="w-full flex flex-col max-tablet:gap-0.5 gap-1.5 my-3">
          <label
            className={`text-base max-tablet:text-xs leading-6 font-medium text-gray-700 `}
          >
            Contact email{" "}
        ...
        <div className="w-full flex flex-col max-tablet:gap-0.5 gap-1.5">
          <label
            className={`text-base max-tablet:text-xs leading-6 font-medium text-gray-700 `}
          >
            Social media links
