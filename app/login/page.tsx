...
export default function Page() {
  ...
  return (
    <div className="pt-[60px] pb-[90px] flex flex-col items-center">
      ...
      <button
        type="button"
        className="h-12 flex font-medium text-base gap-3 items-center rounded border border-[#CDCDE1] px-3.5 cursor-pointer"
      >
      ...
      <div className="w-[405px] mt-8 flex flex-col">
        <div className="relative w-full mb-8 h-full flex justify-center items-center">
          ...
          <p className="text-black/70 font-medium text-base px-3.5 bg-white z-20">
            Or continue with
          </p>
        </div>
        <div className="w-full flex flex-col gap-8 mb-7">
          ...
          <div className="w-full flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <label
                htmlFor="remember"
                className="text-black/70 text-base font-medium"
              >
                Remember me
              </label>
            </div>
            <Link href="/forgot-password" className="font-medium text-black/70">
              Forgot password?
            </Link>
          </div>
        </div>
        ...
        <Button
          variant="default"
          className="bg-[#FF4407] mb-12 hover:bg-[#FF4407]/80 cursor-pointer w-full h-12 rounded-xl text-lg text-white font-bold"
        >
          Continue with Email
        </Button>
        <div className="w-full gap-3 flex items-center justify-center">
          <p className="font-medium text-black/70">Don't have an account?</p>
